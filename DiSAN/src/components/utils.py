...
def greedy_decode(model, src, src_mask, max_len, start_symbol, pad=0, src_mask_dec=None, src_mask_bi=None):
	# pdb.set_trace()
	memory = model.encode(src, src_mask, src_mask_bi)
	...
	for i in range(max_len-1):
		...
		out = model.decode(memory, src_mask_dec, 
						   Variable(ys), # tgt 
						   tgt_mask) 
