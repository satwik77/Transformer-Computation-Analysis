...
class DecoderLayer(nn.Module):
	...
	def __init__(self, args, size, self_attn, src_attn, feed_forward, dropout):
		...
		if args.enc_dec_res:
			...
			self.sublayer2 = SublayerConnectionWres(size, dropout)
		if args.dec_dec_res:
			self.sublayer3 = SublayerConnection(size, dropout)
		else:
			self.sublayer3 = SublayerConnectionWres(size, dropout)
